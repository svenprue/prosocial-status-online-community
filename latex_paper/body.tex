...
Our results do not support Hypothesis 3 in its original form and instead reveal a more nuanced, heterogeneous pattern across the user experience spectrum.

\paragraph{Newcomers: Faster Answers Slightly Strengthen Reciprocity.} For users with less than one week of tenure, the speed interaction coefficient is positive and marginally statistically significant ($\gamma = 0.013$, SE\,=\,0.005, $p < .05$). This indicates that, among newcomers, faster answers are associated with a \textit{weaker} reciprocity effect---the opposite of what our directional hypothesis predicted. However, the magnitude of the moderation is small relative to the substantial base effect observed for this group, and we interpret this as an essentially null moderation: fast and slow answers produce roughly equivalent boosts in helping behavior among newcomers.

\paragraph{Early Experienced Users: Faster Answers Strengthen Reciprocity.} Among users with one week to one month of tenure ($\gamma = -0.010$, SE\,=\,0.005, $p < .05$) and one to six months of tenure ($\gamma = -0.010$, SE\,=\,0.004, $p < .05$), the speed interaction is negative, indicating that faster answers are associated with a stronger reciprocity effect---consistent with our original prediction. The effect for users with six to twelve months of tenure is not statistically significant ($\gamma = -0.004$, SE\,=\,0.004, $p > .10$).

\paragraph{Established Users: Slower Answers Increase Reciprocity.} For users with greater platform experience, the speed interaction coefficient turns positive and statistically significant. The effect is marginally significant for users in the one-to-three-year range ($\gamma = 0.007$, SE\,=\,0.004, $p < .10$) and grows substantially for the most experienced users: three to six years ($\gamma = 0.026$, SE\,=\,0.005, $p < .001$) and more than six years ($\gamma = 0.024$, SE\,=\,0.005, $p < .001$). This indicates that, contrary to our prediction, longer response times are associated with a \textit{stronger} reciprocity effect among the most experienced users.
...
%----------------------------------------------------------------------
\subsection{The Session-Exit Mechanism}
%----------------------------------------------------------------------

We interpret the counterintuitive response time finding through what we term the \textit{session-exit mechanism}. The key insight is not that delayed answers bring disengaged users back to the platform, but rather that fast answers allow users to resolve their immediate need and \textit{leave}. When an experienced user receives a quick answer, their session goal is satisfied; they exit the platform before encountering other questions they might answer. When no answer arrives promptly, the user remains on the platform while they wait, browsing the site, encountering unanswered questions, and helping others during that extended session. The elevated helping we observe among experienced users after long response times is thus a structural consequence of \textit{sustained presence} during the waiting period, not of a motivational boost triggered by the eventual answer.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../analysis/output_figures/help_rate_adoption_by_tenure.pdf}
\caption{Help rate during the post-question window, separately for users who have not yet received an answer (``No answer yet,'' blue) and users who have already received one (``Answer received,'' red), by tenure bucket. The green dashed line shows the cumulative share of users who have received an answer by each hour. For experienced users (all panels except $<$\,1 Week), the help rate of users still waiting (blue) consistently exceeds the help rate of users who have already received an answer (red) up to approximately 1--2 hours post-question. This pattern indicates that receiving an answer is associated with platform \textit{exit} rather than continued engagement: users who get a quick answer resolve their need and leave, while users still waiting remain on the platform and are more likely to help others.}
\label{fig:help_rate_adoption}
\end{figure}

Figure~\ref{fig:help_rate_adoption} provides direct descriptive evidence for this mechanism. For every experienced-user tenure bucket, the help rate of users who have not yet received an answer (blue line) is higher than the help rate of users who have already received one (red line) throughout most of the post-question window---with the two lines crossing only at around one to two hours. This reversal of the expected pattern is incompatible with the emotional immediacy account, which would predict that users who receive an answer quickly should show the highest subsequent helping. Instead, it suggests that receiving an answer is associated with platform \textit{exit}: users whose immediate need is resolved leave the platform, while users still waiting are more likely to remain present and encounter opportunities to help.

The session-exit mechanism predicts that longer response times should be associated with more helping simply because longer waits keep users on the platform longer. This is precisely what the response time interaction captures in the Cox models: for experienced users, each standard deviation increase in log response time is associated with a larger treatment effect on helping hazard. This is not because slow answers motivate stronger reciprocity emotionally, but because slow answers preserve the conditions---continued platform presence---under which helping can occur.

This interpretation is further supported by several patterns in the Cox model estimates. First, the base treatment effect in the speed-interaction model (Model B) is revealing. Because all covariates are mean-centered before fitting, the base coefficient for \textit{isTreatedActive} captures the treatment effect evaluated at the sample mean of the (standardized) response-time interaction term---that is, at the average response time in the data. For several experienced-user buckets, this mean-centered base effect is small or near zero (e.g., $b = -0.006$, $p < .05$ for 1--3 years), indicating that at the average response time, experienced users show little net reciprocity boost. The effect emerges almost entirely from the positive response time interaction, consistent with the session-exit account. Second, the waiting period $\times$ response time interaction is positive and significant across all buckets ($b = 0.015$ to $0.061$, all $p < .001$), indicating that longer response times are associated with greater helping activity \textit{during} the waiting period as well---precisely the pattern expected if users are helping while they wait, rather than after they receive a notification. We note that while the session-exit mechanism is our primary interpretation, complementary psychological processes---such as delayed reflection, or the satisfaction of eventually receiving a thorough answer---may also contribute and cannot be definitively ruled out from the present data alone.
...
For experienced users, the positive relationship between response time and the reciprocity effect contradicts the emotional immediacy account entirely. As described in our results, we propose that this primarily reflects the \textit{session-exit mechanism}: experienced users whose need is resolved quickly by a fast answer exit the platform before encountering other questions they could answer. Users who wait longer remain on the platform during the waiting period and are more likely to help others while there. The elevated helping associated with longer response times is thus largely a structural consequence of \textit{sustained presence} during the waiting session, rather than a motivational boost triggered by the answer itself. Direct descriptive evidence for this mechanism is visible in Figure~\ref{fig:help_rate_adoption}: for experienced users across all tenure levels, the help rate of users still waiting for an answer consistently exceeds the help rate of users who have already received one, up to approximately one to two hours post-question---the opposite of what emotional immediacy would predict. We acknowledge that we cannot definitively rule out complementary psychological processes, such as delayed reflection or the satisfaction of receiving a thorough answer, contributing alongside the session-exit channel.

This finding highlights a broader lesson for translating laboratory theories to field settings. In controlled experiments, participants are present throughout the interaction; there is no platform to leave, no session that ends when a need is met. In field settings, the behavioral dynamics of platform engagement---visit initiation, session duration, exit timing---interact with psychological mechanisms in ways that controlled experiments cannot capture. The session-exit mechanism is not an anomaly but a predictable consequence of how users behave on episodic, task-driven platforms: they arrive with a goal, and when the goal is met quickly, they leave. Future theorizing about reciprocity in online communities should incorporate these structural features of platform engagement alongside the emotional and moral mechanisms that have been the traditional focus.
...
Third, the session-exit mechanism suggests a subtle design tension: fast answers, while clearly valuable for question-askers, may reduce helping by experienced users by ending their platform session prematurely. Platforms could partially offset this effect by surfacing unanswered questions to experienced users at the moment they receive their answer---capitalizing on the brief window before they exit to create an opportunity for helping. This would not delay answers (which is undesirable) but would extend the session slightly beyond the need-resolution moment.
...
Fourth, our response time findings are consistent with the session-exit mechanism, but we measure this indirectly through the moderating effect of response time on helping behavior, and through the descriptive pattern in Figure~\ref{fig:help_rate_adoption}. Future research with access to fine-grained session data---precise login and logout timestamps, page-view sequences, or inactivity-based session boundaries---could directly test whether fast answers shorten sessions and whether the additional helping associated with longer waits occurs within continuous sessions or across separate visits.
