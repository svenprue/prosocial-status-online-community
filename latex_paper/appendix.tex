...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{../matching/common\_support.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{../matching/love\_plot.pdf}
