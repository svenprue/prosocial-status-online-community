...
if __name__ == "__main__":
    input_file = "02_raw_datasets/user_answers_bounty_dataset_sampled_100k.parquet"
    output_file = "03_processed_datasets/user_answers_bounty_processed_sampled_100k.parquet"
