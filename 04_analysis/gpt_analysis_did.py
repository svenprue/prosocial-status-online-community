...
df['treatment'] = np.where((df['question_posted'] >= start_date) & (df['question_posted'] <= end_date), 1, 0)
...
formula = 'hasHelped ~ after_bounty * gpt_month * post_gpt * treatment + log_num_answers_provided * after_bounty'
