...
The Cox analytic sample spans 24,349,760 question-level observations from 3,732,706 unique users on Stack Overflow, with 50\% of questions receiving at least one answer. Help-event counts are right-skewed: the mean is 0.37 events per observation window (SD\,=\,3.08; median 0), consistent with helping being a relatively rare behavior for any individual user in any given window. Among treated users, the median response time from question to first answer is 0.34 hours, though the distribution is heavily right-skewed (mean 5.08 hours, SD\,=\,17.06), reflecting a minority of questions that wait many hours or days for a response. The sample spans all levels of platform experience, with the largest strata being established users (1--3 years: $n=6{,}424{,}968$) and newcomers ($<$\,1 week: $n=4{,}029{,}008$).
